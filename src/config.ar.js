const config = {
  school: {
    ...
    logoPath: `${process.env.PUBLIC_URL}/ar/images/logo.png`,
    ogImagePath: `${process.env.PUBLIC_URL}/ar/images/og-image.jpg`,
    address: {
    ...
    galleryImages: [
      `${process.env.PUBLIC_URL}/ar/images/galary-1.jpeg`,
      `${process.env.PUBLIC_URL}/ar/images/galary-2.jpeg`,
      `${process.env.PUBLIC_URL}/ar/images/galary-3.jpeg`,
      `${process.env.PUBLIC_URL}/ar/images/galary-4.jpeg`,
    ],
    studentsGalleryImages: [
      `${process.env.PUBLIC_URL}/ar/images/student-1.png`,
      `${process.env.PUBLIC_URL}/ar/images/student-2.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-3.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-4.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-5.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-6.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-7.jpg`,
      `${process.env.PUBLIC_URL}/ar/images/student-8.jpg`,
    ],
    thirdSection: {
      ...
      quote: {
        ...
        image: `${process.env.PUBLIC_URL}/ar/images/so-far.jpeg`,
      },
    },
    fourthSection: {
      title: "متنوعة وشاملة",
